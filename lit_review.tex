...
\subsection{Exciton Polariton Condensates}
...
Across the $z$ plane of the semiconductor the band gap varies by alternating the type of doping. 
...
The dispersion relation for the photons, electrons, and the polaritons is shown in XXX. 
In solving the Schr\"{o}dinger one obtains two eigenstates dubbed `upper' and `lower' polaritons, with dispersion shown. 
